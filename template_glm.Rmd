...
The error plot shows the same lower bound as previously discussed. Beyond that we see that the errors have a high level of homoscedasticity for higher fitted values. For lower fitted values we see some off-centering but around a relatively small amount of points. The thicker density around $0$ also suggests a reasonable amount of normality. 
